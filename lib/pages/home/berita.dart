  ...
  Widget build(BuildContext context) {
    return Obx(() => controller.isLoading.value
        ...
        : GridView.builder(
            ...
            itemCount: controller.beritaItem.length,
            shrinkWrap: true,
            ...
            itemBuilder: (_, index) {
              var dataJudul = controller.beritaItem[index].judul!;
              var dataBerita = controller.beritaItem[index].berita!;
              var dataTanggal = controller.beritaItem[index].tanggal!;
              Uint8List decodePhoto;
              decodePhoto = const Base64Decoder()
                  .convert(controller.beritaItem[index].gambar!);
